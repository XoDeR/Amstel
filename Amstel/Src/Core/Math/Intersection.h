...
// Returns the distance along ray (from, direction) to intersection point with sphere <s>
// or -1.0 if no intersection
float getRaySphereIntersection(const Vector3& from, const Vector3& direction, const Sphere& s);

// Returns the distance along ray (from, direction) to intersection point with the oriented
...
// Returns the distance along ray (from, direction) to intersection point with the triangle
